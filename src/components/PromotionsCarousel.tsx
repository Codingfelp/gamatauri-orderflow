...
const promotions: Promotion[] = [
  ...
  },
  {
    ...
    title: 'BEATS Combo',
    description: 'Promoção especial BEATS',
    gradient: '',
    textColor: 'text-white'
  }
];
          ...
          {promotions.map((promo) => (
            <div key={promo.id} className="flex-[0_0_100%] md:flex-[0_0_396px] min-w-0 pl-4">
              <div className="rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                {promo.type === 'image' ? (
                  <div className="relative w-full h-56 md:h-[220px] bg-gradient-to-br from-red-50 to-red-100">
                    <img
                      src={promo.image}
                      alt={promo.title}
                  ...
                  <div
                    className={`relative w-full h-56 md:h-[220px] bg-gradient-to-br ${promo.gradient} p-6 md:p-8 flex flex-col justify-center`}
                  >
